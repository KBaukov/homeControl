Ext.define('MapsGrid', {
    ...
    initColumns: function() {
        ...
        this.columns = [            
            ...
            {header: 'Высона', align: 'left', width: 110, dataIndex: 'h', editor: new Ext.form.TextField({ allowBlank: false }) },
    ...
    delMap: function(grid, rowIndex) {
        ...
        Ext.Msg.show({
            ...
            fn: function(btn){
                if(btn == "yes") {
                    Ext.Ajax.request({
                        url: '/api/maps/delete', scope: this, method: 'GET',
                        params: {id: id},
    ...
    saveData: function() { 
        ...
        if(n>0) {
            for(var i=0; i<n; i++) {
                ...
                Ext.Ajax.request({
                    url: '/api/maps/edit', scope: this, method: 'GET',
                    params: data,
                    success: function(response, opts) {
                      this.unmask();
                      var ansv = Ext.decode(response.responseText);
