Ext.define('MapSensorsGrid', {
    ...
    delSensor: function(grid, rowIndex) {
        ...
        Ext.Msg.show({
            ...
            fn: function(btn){
                if(btn == "yes") {
                    Ext.Ajax.request({
                        url: '/api/sensors/delete', scope: this, method: 'GET',
                        params: {id: id},
    ...
    saveData: function() { 
        ...
        if(n>0) {
            for(var i=0; i<n; i++) {
                ...
                Ext.Ajax.request({
                    url: '/api/sensors/edit', scope: this, method: 'GET',
    ...
    getLastId: function() {
        Ext.Ajax.request({
        url: '/api/sensors/lastid', scope: this, method: 'GET',
        success: function(response, opts) {
          var ansv = Ext.decode(response.responseText);
          if(ansv.success) {  
            this.lastId = ansv.last_id;
